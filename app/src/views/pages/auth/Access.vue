...
<template>
   <div class="min-h-full flex flex-col items-center justify-center">
      ...
      > -->
      <div
         class="w-full rounded-[inherit] bg-surface-0 dark:bg-surface-900 p-20 flex flex-col items-center"
      >
         <div class="gap-8 flex flex-col items-center">
            ...
            <h1 class="text-surface-900 dark:text-surface-0 font-bold text-4xl lg:text-5xl">
               Access Denied
            </h1>
            <img
               src="/demo/images/access/you-shall-not-pass.png"
               alt="Access denied"
               class="max-h-[28rem]"
            />
